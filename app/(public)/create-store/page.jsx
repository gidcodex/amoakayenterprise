...
export default function CreateStore() {
    ...
    if (!user){
        return (
            <div className="min-n-[80vh] mx-6 flex items-center justify-center text-slate-400">
                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on Amoakay Ent. Ltd, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
