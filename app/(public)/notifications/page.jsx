      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-2">
            View shipment updates, order alerts, and account messages.
          </p>
        </div>

        <div className="bg-white border border-slate-100 shadow-xl shadow-slate-200/60 rounded-xl overflow-hidden">
