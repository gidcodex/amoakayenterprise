 ...
 const linkSections = [
  {
    ...
    links: [
      {
        text: t("footer.earphones"),
        path: "/shop?search=earphones",
      },
      {
        text: t("footer.headphones"),
        path: "/shop?search=headphones",
      },
      {
        text: t("footer.smartphones"),
        path: "/shop?search=smartphones",
      },
      {
        text: t("footer.laptops"),
        path: "/shop?search=laptops",
      },
    ],
  },

  {
    title: t("footer.websiteTitle"),
    links: [
      {
        text: t("footer.home"),
        path: "/",
      ...
      {
        text: t("footer.plusMember"),
        path: "/pricing",
      },
      {
        text: t("footer.createStore"),
        path: "/create-store",
      },
    ],
  },

  {
    ...
    links: [
      {
        text: t("footer.email"),
        path: "mailto:support@amoakaydeals.com",
        icon: MailIcon,
      },
      {
        text: t("footer.phone"),
        path: "tel:+233557702453",
        icon: PhoneIcon,
      },
      {
  ...
  return (
    <footer className="border-t border-slate-100 bg-white px-6">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-start justify-between gap-10 border-b border-slate-200 py-10 text-slate-500 md:flex-row">
          <div>
            <Link
              href="/"
            ...
            >
              ...
              Deals
              <span className="text-5xl leading-none text-green-600">
                .
              </span>
            </Link>

            <p className="mt-6 max-w-[410px] text-sm leading-7">
              ...
              {socialIcons.map((item) => {
                ...
                return (
                  <a
                    ...
                    title={item.name}
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition hover:scale-105 hover:bg-green-50 hover:text-green-600"
                  >
                    <Icon />
                  </a>
                );
          ...
          <div className="flex w-full flex-wrap justify-between gap-8 text-sm md:w-[55%]">
            {linkSections.map((section) => (
              <div key={section.title}>
                <h3 className="mb-3 font-semibold text-slate-700 md:mb-5">
                  {section.title}
                </h3>
                  ...
                  {section.links.map((link) => {
                    ...
                    return (
                      <li
                        ...
                        className="flex max-w-[260px] items-start gap-2"
                      >
                        {Icon && (
                        ...
                        <Link
                          href={link.path}
                          className="break-words transition hover:text-green-600 hover:underline"
                        >
                          {link.text}
                        </Link>
                      </li>
